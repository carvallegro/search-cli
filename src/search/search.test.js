...
const { userSearch, ticketSearch, organizationSearch, searchUserById, searchOrganizationById } = require('./index')
...
describe('the search functions', () => {
  ...
  describe('Search organization by id', () => {
    ...
    it('should return the expected organization with string id', () => {
      const actual = searchOrganizationById('101')

      expect(actual).to.deep.equal(expected)
    })

    it('should return the expected organization with integer id', () => {
      const actual = searchOrganizationById(101)
